...
MarketMaker::MarketMaker(const std::string& host, uint16_t port, double mid_price, double spread, uint64_t start_id)
    : Agent(host, port), mid_price_(mid_price), spread_(spread) {
